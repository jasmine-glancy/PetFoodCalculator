...
class CalculateFood():
    ...
    def transition_food_calculator(self, der):
        ...
        # Calculate 100% amounts of both new and old foods
        old_food_amt = round(der / self.pet_data[0]["current_food_kcal"], 2)
        new_food_amt = round(der / self.pet_data[0]["second_food_kcal"], 2)
        ...
        new_food_form = ""
        if self.pet_data[0]["second_food_form"] == "dry":
            new_food_form = "cup"
        elif self.pet_data[0]["second_food_form"] == "can":
            new_food_form = "can"
        elif self.pet_data[0]["second_food_form"] == "pouch":
            new_food_form = "pouch"
